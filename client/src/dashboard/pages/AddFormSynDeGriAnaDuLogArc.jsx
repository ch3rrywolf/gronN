...
const AddFormSynDeGriAnaDuLogArc = () => {
  ...
  const [show, setShow] = useState(false)
    ...
    const submit = async (e) => {
        ...
        await axios.post(`${base_url}/api/createPdfSynDeGriAnaDuLogArc`, data)
            .then(() =>
                axios.get(`${base_url}/api/fetchPdfSynDeGriAnaDuLogArc`, { responseType: 'blob' })
                    .then((res) => {
                        const pdfBlob = new Blob([res.data], { type: 'application/pdf' });
                        saveAs(pdfBlob, 'SYNTHÈSE_DE_LA_GRILLE_DANALYSE_DU_LOGEMEN_ARCADIA.pdf');
                    ...
                    .then(() => 
                        axios.post(`${base_url}/api/sendSynDeGriAnaDuLogArc`, {email})
                            .then((response) => {
  ...
  return (
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        <h2 className='text-xl  text-[#1960a9] hover:text-[#9fc327] font-bold'>Formulaire SYNTHÈSE DE LA GRILLE D'ANALYSE DU LOGEMENT ARCADIA</h2>
...
export default AddFormSynDeGriAnaDuLogArc