...
const AddFormFichDeSynt = () => {
  ...
  const [show, setShow] = useState(false)
    ...
    const submit = async (e) => {
        ...
        await axios.post(`${base_url}/api/createPdfFichDeSynt`, data)
            .then(() =>
                axios.get(`${base_url}/api/fetchPdfFichDeSynt`, { responseType: 'blob' })
                    .then((res) => {
                        const pdfBlob = new Blob([res.data], { type: 'application/pdf' });
                        saveAs(pdfBlob, 'FICHE_DE_SYNTHESE.pdf');
                    ...
                    .then(() => 
                        axios.post(`${base_url}/api/sendFichDeSynt`, {email})
                            .then((response) => {
  ...
  return (
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        <h2 className='text-xl  text-[#1960a9] hover:text-[#9fc327] font-bold'>Formulaire FICHE DE SYNTHESE</h2>
...
<div className='text-center items-center text-black font-bold border border-solid bg-blue-400' >
    <h4>FICHE DE SYNTHESE</h4>
</div>
<div className="overflow-x-auto">
  <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-gray-600">
    <thead>
      <tr>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400" >Type de propriétaire : PO </th>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400">Type de dossier : ECONOMIE D ENERGIE</th>
      </tr>
    </thead>
    <tbody>
<tr>
  ...
  <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-gray-600">
    <thead>
      <tr>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400" >Le(s) demandeur(s) </th>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400" > </th>
...
<tr>
    ...
    <label htmlFor="QV7FDToui" className="ml-2">Nom et prénom :</label>
  </td>
  <td>
    {demandeurNom} {demandeurPreNom} 
  </td>
</tr>

<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Age du(des) demandeur(s) :</label>
  </td>
  <td>
    <div ><input
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Situation familiale :
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Nombre d'occupants :</label>
  </td>
  <td>
    <div ><input
        className='items-center justify-center text-center'
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Revenu fiscal de référence :
    </label>
  </td>
  <td>
    <div ><input
  ...
  <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-gray-600">
    <thead>
      <tr>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400" >LE LOGEMENT </th>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400" > </th>
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Commune :</label>
  </td>
  <td>
    {demandeurCommune}
  </td>
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Adresse du logement :</label>
  </td>
  <td>
    {demandeurAdresse}
  </td>
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Date d'acquisition du logement :
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Type de logement :</label>
  </td>
  <td>
    <div ><input
        className='items-center justify-center text-center'
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Surface habitable (avant travaux) :
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Nombre de pièces :
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Année de construction :
    :
    </label>
  </td>
  <td>
...
<tr>
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Note de dégradation / insalubrité :
    :
    </label>
  </td>
  <td>
  ...
  <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-gray-600">
    <thead>
      <tr>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400" >DESCRIPTIF EXISTANT AVANT TRAVAUX</th>
        </tr>
    </thead>
    <tbody>
<tr>
<td>
  ...
  <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-gray-600">
    <thead>
      <tr>
        <th className="border border-gray-300 px-4 py-2 text-black font-bold  border-solid bg-blue-400" >SITUATION FINANCIÈRE</th>
        </tr>
    </thead>
    <tbody>
<tr>
<td>
  ...
  <div>
    <span className='text-xl'><i>Nous avons que les information de l'avis d'imposition</i>
    </span>
...
<tr>
<td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Revenus mensuels
    </label>
  </td>
  <td>
    <div ><input
  ...
  <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Total des revenus
    :
    </label>
  </td>
  <td>
...
<tr>
<td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Allocations
    </label>
  </td>
  <td>
    <div ><input
  ...
  <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Total des charges
    :
    </label>
  </td>
  <td>
...
<tr>
<td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Prêt(s) en cours
    </label>
  </td>
  <td>
    <div ><input
  ...
  <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Reste à vivre
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
<td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Charges du logement
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
<td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Charges en énergie
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
<td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Charge en eau
    </label>
  </td>
  <td>
    <div ><input
...
<tr>
<td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV7FDToui" className="ml-2">Autres
    </label>
  </td>
  <td>
    <div ><input
...
<div>
  <p>Nom et coordonnées du référent en charge du dossier :<input
        className='items-center justify-center text-center'
            type="text"
            name="QV22FDT"
            value={QV22FDT}
...
export default AddFormFichDeSynt