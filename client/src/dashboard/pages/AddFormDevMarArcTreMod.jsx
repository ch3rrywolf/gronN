...
const AddFormDevMarArcTreMod = () => {
  ...
  const [show, setShow] = useState(false)
    ...
    const submit = async (e) => {
        ...
        await axios.post(`${base_url}/api/createPdfDevMarArcTreMod`, data)
            .then(() =>
                axios.get(`${base_url}/api/fetchPdfDevMarArcTreMod`, { responseType: 'blob' })
                    .then((res) => {
                        const pdfBlob = new Blob([res.data], { type: 'application/pdf' });
                        saveAs(pdfBlob, 'Devis_MAR_ARCADIA_Trés_Modeste.pdf');
                    ...
                    .then(() => 
                        axios.post(`${base_url}/api/sendDevMarArcTreMod`, {email})
                            .then((response) => {
  ...
  return (
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        <h2 className='text-xl  text-[#1960a9] hover:text-[#9fc327] font-bold'>Formulaire Devis MAR ARCADIA Trés Modeste</h2>
...
export default AddFormDevMarArcTreMod