...
const AddFormDevMarTreModVal = () => {
  ...
  const [show, setShow] = useState(false)
    ...
    const submit = async (e) => {
        e.preventDefault();
        const data = {QV0DMTMV,QV1DMTMV,QV2DMTMV,QV3DMTMV,QV4DMTMV,QV5DMTMV,QV6DMTMV,QV7DMTMV,QV8DMTMV,QV9DMTMV,QV10DMTMV,QV11DMTMV,QV12DMTMV,QV13DMTMV, demandeurNom, demandeurPreNom, demandeurAdresse, demandeurCommune, demandeurCodePostal, batiment, etage, porte, escalier, tel, mel, numDossier, dossierStatus, email}

        await axios.post(`${base_url}/api/createPdfDevMarTreModVal`, data)
            .then(() =>
                axios.get(`${base_url}/api/fetchPdfDevMarTreModVal`, { responseType: 'blob' })
                    .then((res) => {
                        const pdfBlob = new Blob([res.data], { type: 'application/pdf' });
                        saveAs(pdfBlob, 'Devis_MAR_Trés_Modeste_VALOREM.pdf');
                    ...
                    .then(() => 
                        axios.post(`${base_url}/api/sendDevMarTreModVal`, {email})
                            .then((response) => {
  ...
  return (
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        <h2 className='text-xl  text-[#1960a9] hover:text-[#9fc327] font-bold'>Formulaire Devis MAR Trés Modeste VALOREM</h2>
...
export default AddFormDevMarTreModVal