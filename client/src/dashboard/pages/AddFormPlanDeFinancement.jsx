...
const AddFormPlanDeFinancement = () => {
  ...
  const [show, setShow] = useState(false)
    ...
    // mise ouvre
    const [QV0FDT,setQV0FDT] = useState([])
    const [QV00FDT,setQV00FDT] = useState([])
        ...
        await axios.post(`${base_url}/api/createPdfPlanDeFinan`, data)
            .then(() =>
                axios.get(`${base_url}/api/fetchPdfPlanDeFinan`, { responseType: 'blob' })
                    ...
                    .then(() => 
                        axios.post(`${base_url}/api/sendPlanDeFinan`, {email})
                            .then((response) => {
  ...
  return (
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        <h2 className='text-xl  text-[#1960a9] hover:text-[#9fc327] font-bold'>Formulaire PLAN DE FINANCEMENT</h2>
...
<div className="overflow-x-auto">
  <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-gray-600">
    ...
    <label htmlFor="QV0FDToui" className="ml-2">DELEGATION</label>
  </td>
  <td>
    <div ><input
        className='items-center justify-center text-center'
            ...
            name="QV0FDT"
            value={QV0FDT}
            onChange={(e)=>setQV0FDT(e.target.value)}
            id="QV0FDT"
            placeholder='.......................................'
          /></div>
  </td>
    ...
    <td className="border border-gray-300 px-4 py-2 text-start">
    <label htmlFor="QV00FDToui" className="ml-2">Date du dépôt</label>
  </td>
  <td>
    <div ><input
        className='items-center justify-center text-center'
            ...
            name="QV00FDT"
            value={QV00FDT}
            onChange={(e)=>setQV00FDT(e.target.value)}
            id="QV00FDT"
...
<div className="overflow-x-auto">
  <table className="table-auto w-full border-collapse border border-gray-300 text-sm text-gray-600">
    ...
    <input
      ...
      type="checkbox"
      value="X"
      checked={Q1FDT.includes("X")}
      onChange={(e) => {
        if (e.target.checked) {
          setQ1FDT([...Q1FDT, "X"]);
        } else {
          setQ1FDT(Q1FDT.filter((val) => val !== "X"));
        }
      }}
    />
...
<tr>
    ...
    <input
      ...
      type="checkbox"
      value="X"
      checked={Q2FDT.includes("X")}
      onChange={(e) => {
        if (e.target.checked) {
          setQ2FDT([...Q2FDT, "X"]);
        } else {
          setQ2FDT(Q2FDT.filter((val) => val !== "X"));
        }
      }}
    />
...
<tr>
    ...
    <input
      ...
      type="checkbox"
      value="X"
      checked={Q3FDT.includes("X")}
      onChange={(e) => {
        if (e.target.checked) {
          setQ3FDT([...Q3FDT, "X"]);
        } else {
          setQ3FDT(Q3FDT.filter((val) => val !== "X"));
        }
      }}
    />
...
<tr>
    ...
    <input
      ...
      type="checkbox"
      value="X"
      checked={Q5FDT.includes("X")}
      onChange={(e) => {
        if (e.target.checked) {
          setQ5FDT([...Q5FDT, "X"]);
        } else {
          setQ5FDT(Q5FDT.filter((val) => val !== "X"));
        }
      }}
    />
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q9nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ9nFDT([...Q9nFDT, "X"]);
          } else {
            setQ9nFDT(Q9nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q9oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ9oFDT([...Q9oFDT, "X"]);
          } else {
            setQ9oFDT(Q9oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q10nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ10nFDT([...Q10nFDT, "X"]);
          } else {
            setQ10nFDT(Q10nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q10oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ10oFDT([...Q10oFDT, "X"]);
          } else {
            setQ10oFDT(Q10oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q11nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ11nFDT([...Q11nFDT, "X"]);
          } else {
            setQ11nFDT(Q11nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q11oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ11oFDT([...Q11oFDT, "X"]);
          } else {
            setQ11oFDT(Q11oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q12nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ12nFDT([...Q12nFDT, "X"]);
          } else {
            setQ12nFDT(Q12nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q12oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ12oFDT([...Q12oFDT, "X"]);
          } else {
            setQ12oFDT(Q12oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q13nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ13nFDT([...Q13nFDT, "X"]);
          } else {
            setQ13nFDT(Q13nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q13oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ13oFDT([...Q13oFDT, "X"]);
          } else {
            setQ13oFDT(Q13oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q14nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ14nFDT([...Q14nFDT, "X"]);
          } else {
            setQ14nFDT(Q14nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q14oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ14oFDT([...Q14oFDT, "X"]);
          } else {
            setQ14oFDT(Q14oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
...
<td className="border border-gray-300 px-4 py-2 text-start flex justify-between items-center">
  ...
  <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q15FDT1.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ15FDT1([...Q15FDT1, "X"]);
          } else {
            setQ15FDT1(Q15FDT1.filter((val) => val !== "X"));
          }
        }}
      />
      CNAV/CARSAT
    ...
    <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q15FDT2.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ15FDT2([...Q15FDT2, "X"]);
          } else {
            setQ15FDT2(Q15FDT2.filter((val) => val !== "X"));
          }
        }}
      />
      MSA
    ...
    <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q15FDT3.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ15FDT3([...Q15FDT3, "X"]);
          } else {
            setQ15FDT3(Q15FDT3.filter((val) => val !== "X"));
          }
        }}
      />
      RSI
    ...
    <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q15FDT4.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ15FDT4([...Q15FDT4, "X"]);
          } else {
            setQ15FDT4(Q15FDT4.filter((val) => val !== "X"));
          }
        }}
      />
      Autres
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q16nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ16nFDT([...Q16nFDT, "X"]);
          } else {
            setQ16nFDT(Q16nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q16oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ16oFDT([...Q16oFDT, "X"]);
          } else {
            setQ16oFDT(Q16oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
...
<td className="border border-gray-300 px-4 py-2 text-start flex justify-between items-center">
  ...
  <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q17FDT1.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ17FDT1([...Q17FDT1, "X"]);
          } else {
            setQ17FDT1(Q17FDT1.filter((val) => val !== "X"));
          }
        }}
      />
      AGIRC
    ...
    <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q17FDT2.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ17FDT2([...Q17FDT2, "X"]);
          } else {
            setQ17FDT2(Q17FDT2.filter((val) => val !== "X"));
          }
        }}
      />
      ARRCO
    ...
    <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q17FDT3.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ17FDT3([...Q17FDT3, "X"]);
          } else {
            setQ17FDT3(Q17FDT3.filter((val) => val !== "X"));
          }
        }}
      />
      IRCANTEC
    ...
    <label className="flex items-center gap-1">
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q17FDT4.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ17FDT4([...Q17FDT4, "X"]);
          } else {
            setQ17FDT4(Q17FDT4.filter((val) => val !== "X"));
          }
        }}
      />
      Autres
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q18nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ18nFDT([...Q18nFDT, "X"]);
          } else {
            setQ18nFDT(Q18nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q18oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ18oFDT([...Q18oFDT, "X"]);
          } else {
            setQ18oFDT(Q18oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
  ...
  <label className="flex items-center gap-1">
    non
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q20nFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ20nFDT([...Q20nFDT, "X"]);
          } else {
            setQ20nFDT(Q20nFDT.filter((val) => val !== "X"));
          }
        }}
      />
    ...
    <label className="flex items-center gap-1">
      ...
      <input
        ...
        type="checkbox"
        value="X"
        checked={Q20oFDT.includes("X")}
        onChange={(e) => {
          if (e.target.checked) {
            setQ20oFDT([...Q20oFDT, "X"]);
          } else {
            setQ20oFDT(Q20oFDT.filter((val) => val !== "X"));
          }
        }}
      />
    </label>
...
export default AddFormPlanDeFinancement