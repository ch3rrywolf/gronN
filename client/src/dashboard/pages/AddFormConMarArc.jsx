...
const AddFormConMarArc = () => {
  ...
  const [show, setShow] = useState(false)
    ...
    const submit = async (e) => {
        ...
        await axios.post(`${base_url}/api/createPdfConMarArc`, data)
            .then(() =>
                axios.get(`${base_url}/api/fetchPdfConMarArc`, { responseType: 'blob' })
                    .then((res) => {
                        const pdfBlob = new Blob([res.data], { type: 'application/pdf' });
                        saveAs(pdfBlob, 'CONTRAT_MAR_ARCADIA.pdf');
                    ...
                    .then(() => 
                        axios.post(`${base_url}/api/sendConMarArc`, {email})
                            .then((response) => {
  ...
  return (
    <div className='bg-white rounded-md'>
      <div className='flex justify-between p-4'>
        <h2 className='text-xl  text-[#1960a9] hover:text-[#9fc327] font-bold'>Formulaire CONTRAT MAR ARCADIA</h2>
...
export default AddFormConMarArc